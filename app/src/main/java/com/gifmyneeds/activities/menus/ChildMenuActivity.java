...
import java.util.ArrayList;
    ...
    public class ChildMenuActivity extends AppCompatActivity implements SearchView.OnQueryTextListener,View.OnClickListener {
        ...
        public void onClick(View view) {
            switch(view.getId()) {
                case R.id.btnAddChild:
                    startActivityForResult(new Intent(ChildMenuActivity.this, AddChildActivity.class), REQUEST_ADDCHILD);
                    break;
                ...
                case R.id.btnEditChildBoard:
                    if (selectedChild!=null) {
                        Intent i = new Intent(ChildMenuActivity.this, SelectCategoryForBoardActivity.class);
